...
var scrollVis = function() {
  ...
  setupVis = function(wordData, fillerCounts, histData) {
    ...
    g.append("image")
        .attr("class", "anger-image")
        .attr('x', 0)
        .attr('y', height / 3 - height / 6)
        .attr('width', 800)
        .attr('height', 600)
        .attr("xlink:href","images/anger/demo-anger.jpg")
        .attr("opacity", "1")
//changed this

    //changed this
    // g.selectAll(".anger-image")
    //     .style("display", "null")
        //.attr("opacity", 1);
    ...
    g.append("text")
      ...
      .attr("y", height / 3 - height / 4)
        .attr("color", "white")
      .text("Teen Activists Shut Down Chicago Streets");

    g.append("text")
      .attr("class", "sub-title openvis-title")
      .attr("x", width / 2)
      .attr("y", (height / 2) - height / 3)
      .text("With Peaceful Black Lives Matter Protest");
    ...
    //   circle
    //       .attr("cx", function(d) { d.x += Math.random()*3*Math.sin(Math.random()*3*d.x + Math.random()*10); if (d.x > width) d.x -= width; else if (d.x < 0) d.x += width; return d.x; })
    //       .attr("cy", function(d) { d.y += d.dy ; if (d.y > height) d.y -= h; else if (d.y < 0) d.y += height; return d.y; })
    //       .attr("r",function(d)
    //       {
